...
export type InterfaceCreateAccountType = {
  className?: string;
};
...
const BotoIniciarSessoWrapper = styled.div`
  ...
  align-items: flex-start;
  justify-content: flex-start;
  padding: 0rem 0rem var(--padding-4xl-6);
  box-sizing: border-box;
  max-width: 100%;
`;
...
const InterfaceCreateAccount: FunctionComponent<InterfaceCreateAccountType> = ({
  className = "",
}) => {
      ...
      <InputContainersWrapper>
        <InputContainers>
          ...
          <SenhaParent>
            ...
            <RectangleParent>
              <InputValuesChild />
              <UrsulaGrantoSeguros placeholder="************" type="text" />
            </RectangleParent>
          </SenhaParent>
        </InputContainers>
      </InputContainersWrapper>
      ...
      <SubmitButtonWrapper>
        ...
        <Grantosegurosimage21Wrapper>
          <Grantosegurosimage21Icon
            loading="lazy"
            alt=""
            src="/grantosegurosimage2-11@2x.png"
          />
        </Grantosegurosimage21Wrapper>
      </SubmitButtonWrapper>
    </InterfaceLoginRoot>
...
export default InterfaceCreateAccount;
